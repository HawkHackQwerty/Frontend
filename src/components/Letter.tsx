  ...
  return (
    <>
      ...
      <ChakraProvider>
        ...
        >
          <Text fontSize="3xl" fontWeight="bold" mb="20px">Cover Letter Editing</Text> {/* Add the title */}
          <Box>
            ...
            <Button marginTop="-120px" width="350px" mx="auto" colorScheme="teal" onClick={handleReplacePdf}>Replace PDF</Button>
            <Button marginTop="-67px" width="350px" float="right" mx="auto" colorScheme="teal" onClick={handleSubmitPdf}>Submit PDF</Button>
          </Box>
